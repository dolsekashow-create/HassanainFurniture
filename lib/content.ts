...
export const EMAIL = 'Hassanain.mustafa@gmail.com'
...
export const MAP_DAMIETTA = 'https://maps.app.goo.gl/uE88sZSvLHTsUSELA?g_st=iw'
export const MAP_ALEXANDRIA = 'https://maps.app.goo.gl/TSPYyiR6pJLw1GnC9?g_st=iw'
export const MAP_NORTH_SQUARE = 'https://maps.app.goo.gl/2kEok7xUDK2hRTNs5?g_st=iw'
export const CATALOGUE_PDF = '/catalogue/hassanain-catalogue.pdf'
export const CATALOGUE_PAGES = 47
export const cataloguePage = (n: number) =>
  `/catalogue/pages/page-${String(n).padStart(2, '0')}.jpg`
...
const en: Dict = {
  ...
  hero: {
    ...
    ctaCatalogue: 'Browse catalogue and prices',
    ctaPackages: 'Packages',
    ctaShowroom: 'Visit Showroom',
    ctaCustomOrder: 'Start your custom order',
    customOrderMessage:
      'Hello Hassanain Furniture, I would like to start a custom order.',
    scroll: 'Scroll',
  },
  about: {
    eyebrow: 'About Us',
  ...
  catalogue: {
    ...
    title: 'Browse the full catalogue right here.',
...
const ar: Dict = {
  ...
  hero: {
    ...
    ctaCatalogue: 'تصفح الكتالوج والأسعار',
    ctaPackages: 'العروض',
    ctaShowroom: 'زيارة المعرض',
    ctaCustomOrder: 'اطلب تفصيل خاص',
    customOrderMessage: 'أهلاً حسنين للأثاث، حابب أعمل طلب تفصيل خاص.',
    scroll: 'انزل',
  },
  about: {
    eyebrow: 'من نحن',
  ...
  catalogue: {
    eyebrow: 'الكتالوج',
    title: 'تصفح الكتالوج كامل من هنا.',
    ...
    swipeHint: 'اسحب يمين أو شمال لتقليب الصفحات.',
  },
  packages: {
    eyebrow: 'العروض',
